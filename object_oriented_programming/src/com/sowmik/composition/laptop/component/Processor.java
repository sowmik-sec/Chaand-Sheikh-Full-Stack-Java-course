package com.sowmik.composition.laptop.component;
...
public class Processor {
	...
	public Processor() {
		...
		this.minFrequency = "1.2 MHz";
		this.maxFrequency = "3.1 GHz";
	}
	public Processor(String brand, String series, int generation, int cores, int threads, String cacheMemory, String frequency,
